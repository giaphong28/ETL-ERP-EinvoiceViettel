...
public class buyerInfo {
    ...
    public static JSONObject getBuyerInfo(String bank_id, String vs_site_id)
            throws Exception {
...
//        String output_checking = "";
        try {// TODO code application logic here
            ...
            buyerInvoiceInfo.put("BANK_BRANCH_NAME", "");//buyerBankName
            ...
            // Construct query
            String bank_column_name
                    = "BANK_ACCOUNT_NUM"//bankAccountNum
                    ;
            String table_name_bank = "HR.SYS_MASTER_VS_BANKS";
            String filter_statement_bank = " where"
                    + " VS_ID = " + buyerInvoiceInfo.get("VS_ID");
            ...
            //select query data
            ResultSet result_bank = stmt_bank.executeQuery(
                    "select " + bank_column_name
                    + " from " + table_name_bank
            ...
            if (!buyerInvoiceInfo.get("BANK_ID").equals("")) {
                // Construct query
                String banks_column_name
                        = "BANK_NAME"//bankName
                        ;
                String table_name_banks = "AP.AP_BANKS";
                String filter_statement_banks = " where"
                        + " BANK_ID = "
                        + buyerInvoiceInfo.get("BANK_ID");
                ...
                //select query data
                ResultSet result_banks = stmt_banks.executeQuery(
                        "select " + banks_column_name
                        + " from " + table_name_banks

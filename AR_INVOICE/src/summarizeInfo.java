    ...
    public static JSONObject getSummarizeInfo()
        ...
        try {
            ...
            HashMap<String, String> items = ItemInfo.items;
                ...
                sumOfTotalLineAmountWithoutTax += Long.parseLong(items.get("AMOUNT"));
                totalAmountWithoutTax += Long.parseLong(items.get("AMOUNT"));
                totalTaxAmount += Long.parseLong(items.get("TAX_AMOUNT"));
                totalAmountWithTax += Long.parseLong(items.get("AMOUNT_WITH_TAX"));
                totalAmountAfterDiscount += Long.parseLong(items.get("AMOUNT_AFTER_DISCOUNT"));
                DiscountAmount += Long.parseLong(items.get("PERCENT_DISCOUNT"))*

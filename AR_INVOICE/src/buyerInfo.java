...
public class buyerInfo {
	...
	public static JSONObject getBuyerInfo(String vs_site_id) throws Exception {
		...
		try {
			// sử dụng hashmap để lấy dữ liệu nhận được từ API
			...
			// xây dựng câu truy vấn thông tin người mua
			...
			// Cấu hình truy vấn thông tin ngân hàng
			...
			if (!buyerInvoiceInfo.get("BANK_ID").equals("")) {
				// cấu hình truy vấn tên ngân hàng
